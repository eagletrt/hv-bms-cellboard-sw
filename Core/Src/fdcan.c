...
void MX_FDCAN1_Init(void) {
    ...
    FDCAN_FilterTypeDef f1 = {
        ...
        .FilterConfig = FDCAN_FILTER_TO_RXFIFO0,
        .FilterID1 = CAN_BMS_MESSAGE_FRAME_ID_TSACMAINBOARDBALANCINGSET,
        .FilterID2 = CAN_BMS_MESSAGE_FRAME_ID_TSACMAINBOARDFLASHSET
    };
    FDCAN_FilterTypeDef f2 = {
        ...
        .FilterType = FDCAN_FILTER_DUAL,
        .FilterConfig = FDCAN_FILTER_TO_RXFIFO0,
        .FilterID1 = CAN_BMS_MESSAGE_FRAME_ID_TSACCELLBOARD1FLASH,
        .FilterID2 = CAN_BMS_MESSAGE_FRAME_ID_TSACMAINBOARDFLASHCELLBOARD1
    };
