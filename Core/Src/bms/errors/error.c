 ...
 *
 * Error_gen version 1.5.0
 * Generation date: 2024-06-13 17:50:51 +0200
 * Generated from: errors.json
 * With prefix: none
 * The error handler contains:
 *     - 6 error groups
 *     - 6 total error instances
 ******************************************************************************/
...
static const uint16_t timeouts[] = {
    [ERROR_GROUP_CELLBOARD_ID] = 0,
    [ERROR_GROUP_UNDER_VOLTAGE] = 50,
    [ERROR_GROUP_OVER_VOLTAGE] = 50,
    [ERROR_GROUP_UNDER_TEMPERATURE] = 200,
    [ERROR_GROUP_OVER_TEMPERATURE] = 200,
    [ERROR_GROUP_CAN] = 100
};

// Errors information
static Error error_cellboard_id_instances[1];
...
void error_init(void (* cs_enter)(void), void (* cs_exit)(void)) {
    ...
    for (size_t i = 0; i < instances[ERROR_GROUP_CELLBOARD_ID]; ++i)
        error_cellboard_id_instances[i].group = ERROR_GROUP_CELLBOARD_ID;
    for (size_t i = 0; i < instances[ERROR_GROUP_UNDER_VOLTAGE]; ++i)
        error_under_voltage_instances[i].group = ERROR_GROUP_UNDER_VOLTAGE;
    for (size_t i = 0; i < instances[ERROR_GROUP_OVER_VOLTAGE]; ++i)
        error_over_voltage_instances[i].group = ERROR_GROUP_OVER_VOLTAGE;
    for (size_t i = 0; i < instances[ERROR_GROUP_UNDER_TEMPERATURE]; ++i)
        error_under_temperature_instances[i].group = ERROR_GROUP_UNDER_TEMPERATURE;
    for (size_t i = 0; i < instances[ERROR_GROUP_OVER_TEMPERATURE]; ++i)
        error_over_temperature_instances[i].group = ERROR_GROUP_OVER_TEMPERATURE;
    for (size_t i = 0; i < instances[ERROR_GROUP_CAN]; ++i)
        error_can_instances[i].group = ERROR_GROUP_CAN;
}
