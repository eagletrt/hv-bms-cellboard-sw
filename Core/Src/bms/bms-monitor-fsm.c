...
const char *bms_monitor_fsm_state_names[] = {"init", "write_configuration", "read_configuration", "start_volt_conversion", "start_temp_conversion", "start_open_wire_pud_conversion", "poll_volt_status", "read_voltage", "poll_temp_status", "read_temperature", "poll_open_wire_pud_status", "read_open_wire_pud", "start_open_wire_pup_conversion", "poll_open_wire_pup_status", "read_open_wire_pup"};
...
bms_monitor_fsm_state_t bms_monitor_fsm_do_start_open_wire_pud_conversion(bms_monitor_fsm_state_data_t *data) {
  ...
  // bms_manager_start_open_wire_conversion(Ltc6811Pup pull_up)
