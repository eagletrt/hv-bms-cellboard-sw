...
const char *bms_monitor_fsm_state_names[] = {"init", "write_configuration", "read_configuration", "start_volt_conversion", "poll_volt_status", "read_voltage"};

// List of state functions
state_func_t *const bms_monitor_fsm_state_table[BMS_MONITOR_FSM_NUM_STATES] = {
