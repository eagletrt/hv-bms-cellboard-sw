...
/** @brief Total number of open wire conversions with pull-up and pull-down */
#define BMS_MONITOR_FSM_OPEN_WIRE_PUP_CONVERSION_COUNT (2U)
#define BMS_MONITOR_FSM_OPEN_WIRE_PUD_CONVERSION_COUNT (2U)

/** @brief Max number of poll attempts before returning to write_configuration */
#define FSM_MAX_POLL_ERR_COUNT 3
...
typedef struct {
    ...
    size_t open_wire_operations;

    size_t poll_err_count;
