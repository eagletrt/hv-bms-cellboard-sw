 ...
 * \{
 */
#define TEMP_DISCHARGE_COEFF_0 (210.641402547789426)
#define TEMP_DISCHARGE_COEFF_1 (-229.675597262809305)
#define TEMP_DISCHARGE_COEFF_2 (183.408958289812375)
#define TEMP_DISCHARGE_COEFF_3 (-79.342085848426848)
#define TEMP_DISCHARGE_COEFF_4 (16.358984712381918)
#define TEMP_DISCHARGE_COEFF_5 (-1.279537928208531)
