...
/* ##Boot Set the frequency of the crystal oscillator that provides the clock
 * signal that drives the microcontroller. Specify the value in kHz. 
 */
#define BOOT_CPU_XTAL_SPEED_KHZ          (16000)
/** \brief Desired system speed. */
/* ##Boot Set the system frequency of the microcontroller system clock. Specify the
...
/* ##Boot Configure the CPU's endian mode. This is hardware specific and should be
...
/* ##Boot Configure the size of the flash memory device on the microcontroller.
